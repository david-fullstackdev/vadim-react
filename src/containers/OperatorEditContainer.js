...
import OperatorEditComponent from '../components/accounts/OperatorEditComponent';
import LoopbackHttp from '../businessLogic/LoopbackHttp.js';
import objectAssign from 'object-assign';
import _ from 'lodash';
import { gettext } from '../i18n/service';

export class OperatorEditContainer extends React.Component {
  ...
  saveChanges(e) {
    ...
    this.props.actions.updateOperator(accountId, newAccount);
  }
...
OperatorEditContainer.propTypes = {
...
function mapStateToProps(state, props) {
  const account = props.params.operatorId ?
    _.find(state.appReducer.users, {id: props.params.operatorId}) :
