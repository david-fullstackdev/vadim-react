...
const GLOBALS = {
  ...
  'process.env.BASE_API': JSON.stringify('https://api.dook.sa/api/'),
  'process.env.BASE_STREAMS': JSON.stringify('https://api.dook.sa/api/'),
  'process.env.__VERSION__': JSON.stringify(version),
  'process.env.publicPath': 'https://portal.dook.sa/',
  __DEV__: false
};
